...
public final class FragmentReelsBinding implements ViewBinding {
  ...
  private FragmentReelsBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton floating, @NonNull ViewPager2 viewpager) {
  ...
  public static FragmentReelsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.floating;
      FloatingActionButton floating = ViewBindings.findChildViewById(rootView, id);
      if (floating == null) {
        break missingId;
      }
      ...
      return new FragmentReelsBinding((ConstraintLayout) rootView, floating, viewpager);
    }
